...
- **Observability and integrations**: dependency-free Prometheus `/api/metrics`,
  SSE execution events, `WebhookEventSink`, `SCHEDFLOW_LOG_FORMAT=json`
  structured logs and token-bucket rate limiting for write requests;
